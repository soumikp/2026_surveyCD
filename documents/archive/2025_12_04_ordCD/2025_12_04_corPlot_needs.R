...
cor_map_needs <- pheatmap(
  cor_matrix,
  main = "Polychoric Correlation Heatmap: Outcomes vs Needs\n(UPDATED 12.04.25 - no changes from 11.18.25)",
  fontsize = 12,
...
factor <- 1.5
ggsave("C:/Users/VHAPTHPURKAS/OneDrive - University of Pittsburgh/CHERP/2024_shep_hausmann/2025_12_04_ordCD/2025_12_04_corPlot_needs.pdf", 
       cor_map_needs, 
       height = factor*8.5,
       width = factor*10, 
       units = "in", 
